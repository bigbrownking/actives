...
select
    ...
    concat('Снятие ДС-',' Сумма:',cast(OPER_TENGE_AMOUNT as int),';ID сообщения:',MESS_ID,';Код вида операции:',OPER_IDVIEW, '; Номер операции:',OPER_NUMBER,';') as dopinfo,
...
from pfr_dashboard.asloy_joined_table where DATE_OPER>='2023-01-01' and DATE_OPER<='2023-12-31' and (OPER_IDVIEW='311' or OPER_IDVIEW='321' or OPER_IDVIEW='511' or OPER_IDVIEW='530')
