...
select
    ...
    concat('ID сообщения:',MESS_ID,';Код вида операции:',OPER_IDVIEW, '; Номер операции:',OPER_NUMBER,';') as dopinfo,
...
from asloy_joined_table where DATE_OPER>='2023-01-01' and DATE_OPER<='2023-12-31' and lowerUTF8(dopinfo) not like '%сейфул%' and
